...
class TrimmingTheText : PrintableForm
{
    ...
    protected override void DoPage(Graphics grfx, Color clr, int cx, int cy)
    {
        ...
        grfx.DrawString("EllipsisWord: " + str, Font, brush, rectf, strfmt);

        rectf.Offset(0, cyRect + cyText);

        strfmt.Trimming = StringTrimming.EllipsisPath;
        grfx.DrawString("EllipsisPath: " + Environment.GetFolderPath(Environment.SpecialFolder.Personal), Font, brush, rectf, strfmt);
