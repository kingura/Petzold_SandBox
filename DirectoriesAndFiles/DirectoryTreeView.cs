...
class DirectoryTreeView : TreeView
{
  public DirectoryTreeView()
  {
    ...
    ImageList.Images.Add(new Bitmap(GetType(), "DirectoriesAndFiles.35FLOPPY.BMP"));
    ImageList.Images.Add(new Bitmap(GetType(), "DirectoriesAndFiles.CLSDFOLD.BMP"));
    ImageList.Images.Add(new Bitmap(GetType(), "DirectoriesAndFiles.OPENFOLD.BMP"));
