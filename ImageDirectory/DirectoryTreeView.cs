...
class DirectoryTreeView : TreeView
{
  public DirectoryTreeView()
  {
    ...
    ImageList.Images.Add(new Bitmap(GetType(), "ImageDirectory.35FLOPPY.BMP"));
    ImageList.Images.Add(new Bitmap(GetType(), "ImageDirectory.CLSDFOLD.BMP"));
    ImageList.Images.Add(new Bitmap(GetType(), "ImageDirectory.OPENFOLD.BMP"));
