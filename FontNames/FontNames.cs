...
class FontNames:PrintableForm
{
    ...
    {
        string[] astrFonts = { "Courier New", "Arial", "Times New Roman" }; //{ "Comic Sans MS" };
        FontStyle[] afs = { FontStyle.Regular, FontStyle.Bold, FontStyle.Italic, FontStyle.Bold | FontStyle.Italic};
