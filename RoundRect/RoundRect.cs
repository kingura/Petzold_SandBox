...
class RoundRect: PrintableForm
{
    ...
    {
        grfx.DrawLine(pen, size.Width / 2, rect.Top,
        ...
        grfx.DrawLine(pen, rect.Right, size.Height/2,
                           rect.Right, rect.Bottom - size.Height / 2);

        grfx.DrawArc(pen, rect.Right - size.Width, rect.Bottom - size.Height,
                          size.Width, size.Height,
                          0, 90);

        grfx.DrawLine(pen, size.Width / 2, rect.Bottom,
                           rect.Right - size.Width / 2, rect.Bottom);

        grfx.DrawArc(pen, rect.Left, rect.Bottom - size.Height,
                          size.Width, size.Height,
                          90, 90);

        grfx.DrawLine(pen, rect.Left, size.Height / 2,
                           rect.Left, rect.Bottom - size.Height / 2);
