...
class HuckleberryFinnHalfHelght : Form
{
    public static void Main()
    {
        Application.Run(new HuckleberryFinnHalfHelght());
    }

    public HuckleberryFinnHalfHelght()
    {
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        grfx.DrawString("You don't know about me, without you " +
