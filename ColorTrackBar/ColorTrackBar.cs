...
internal class ColorTrackBar : Form
{
    private Panel panel;
    private Label[] alabelName = new Label[3];
    private Label[] alabelValue = new Label[3];
    private TrackBar[] atrackbar = new TrackBar[3];
    ...
    public ColorTrackBar()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            atrackbar[i].Width = 42;
            atrackbar[i].ValueChanged += TrackBarOnValueChanged;
    ...
    protected override void OnResize(EventArgs e)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            atrackbar[i].Location = new Point((1 + 2 * i) * cx / 12 - atrackbar[i].Width / 2,
                                              2 * cyFont);
    ...
    private void TrackBarOnValueChanged(object obj, EventArgs e)
    {
        for (int i = 0; i < 3; i++)
