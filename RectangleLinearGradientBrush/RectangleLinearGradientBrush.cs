...
class RectangleLinearGradientBrush : PrintableForm
{
  ...
  public RectangleLinearGradientBrush()
  {
    ...
    foreach (LinearGradientMode gm in Enum.GetValues(typeof(LinearGradientMode)))
    {
  ...
  {
    Rectangle rectBrush = new Rectangle(cx/4, cy/4, cx/2, cy/2);
    
    LinearGradientBrush lgbrush =
      new LinearGradientBrush(rectBrush,Color.White, Color.Black, (LinearGradientMode) miChecked.Index);
