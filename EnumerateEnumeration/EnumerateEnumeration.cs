...
using System.Reflection;  // Для класса Assembly
using System.Text;        // Для класа StringBuilder
...
class EnumerateEnumeration: Form
{
                                    ...
                                    string strEnumeration, bool bHexadecimal)
  {
    ...
    try
    {
      ...
      strAssembly = Assembly.LoadWithPartialName(strLibrary).FullName;
      #pragma warning restore CS0618 // Type or member is obsolete
      //strAssembly = Assembly.Load(strLibrary).FullName;
    }
    catch
    {
      return false;
