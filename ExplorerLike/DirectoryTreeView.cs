...
class DirectoryTreeView : TreeView
{
  public DirectoryTreeView()
  {
    ...
    ImageList.Images.Add(new Bitmap(GetType(), "ExplorerLike.35FLOPPY.BMP"));
    ImageList.Images.Add(new Bitmap(GetType(), "ExplorerLike.CLSDFOLD.BMP"));
    ImageList.Images.Add(new Bitmap(GetType(), "ExplorerLike.OPENFOLD.BMP"));
