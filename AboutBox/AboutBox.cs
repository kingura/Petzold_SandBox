...
class AboutBox : Form
{
    ...
    public AboutBox()
    {
        ...
        Menu.MenuItems[0].MenuItems.Add("&AboutAboutBox...", new EventHandler(MenuAboutOnClick));
    }
...
class AboutDialogBox : Form
{
    public AboutDialogBox()
    {
        ...
        label1.Font = new Font(FontFamily.GenericSerif, 24, FontStyle.Italic);
        ...
        label2.Parent = this;
        label2.Text = "\x00A9 2018 by Joe Black";
